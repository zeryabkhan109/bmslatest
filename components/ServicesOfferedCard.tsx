    ...
    <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-6 items-center">
      {servicesData.map((item) => (
        ...
        >
          ...
          <div className="mt-4">
            <h3 className="text-white-1100 text-sm leading-4.25 md:leading-4.75 xl:text-base xl:leading-[140%] font-bold">
              {item.title}
            ...
            <p className="text-white-1100 text-xs leading-[140%] font-normal mt-2 md:mb-0 mb-3 md:min-h-16.75 xl:min-h-22.5 line-clamp-4">
              {item.description}
            </p>
